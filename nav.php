  		...
  		<div class="container-fluid col-md-offset-1 col-md-10">
  			<div class="navbar-header">
			    ...
			    <ul class="nav navbar-nav">
			      	...
			      	<li><a href="upload-upload.php" style="margin-top:-15px; height:65px;"><button class="btn-primary btn navbar-btn" 
			      		role="button">Upload</button></a></li>
			    </ul>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<label class="col-md-9" style="right: 35px;">Not a member yet? <a href="signup.php">Sign Up</a></label>
							</div>
						</div>
					</div>
				</div>
